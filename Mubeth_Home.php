        ...
        if(empty($res_row)){
            ...
            foreach ($res_row as $row) {
                ...
                <div class="card-body">
                    ...
                    <a type="button" href="Mubeth_Detail.php?id='.$row['id'].'" class="btn btn-primary">Tampilkan Lebih Lanjut</a>
                </div>
                </div>
                ';
            }
