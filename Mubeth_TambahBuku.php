...
<body>
        ...
        <nav class="d-flex flex-wrap justify-content-between align-items-center w-100">
            <div class="col-md-4 d-flex align-items-start px-2">
                <span class="logo"><a href="Mubeth_Home.php"><img src="assets/logo-ead.png" alt="logo" width="130px"></a></span>
            </div>
            <div class="col-md-4 justify-content-end d-flex px-2">
                <a href="Mubeth_TambahBuku.php" class="btn btn-primary">
                    Tambah Buku
                </a>
            </div>
        </nav>
   ...
   <div class="container container-fluid">
       ...
       <div class="container">
            <div class="content-page">
                ...
                <form action="Mubeth_home.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class= "form-group mb-4">
                        ...
                        <input type="text" class="form-control mt-2" name="Penulis_buku" 
                                aria-describedby="titleHelp" placeholder="Mubeth_1202190125" value="Mubeth_1202190125" 
                    ...
                    <div class= "form-group mb-4">
                        ...
                        <input type="text" class="form-control mt-2" name="Tahun_terbit" 
                                aria-describedby="titleHelp" placeholder="Contoh: 2019" 
                                autocomplete="off">
                    </div>
                    ...
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Pemrograman" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">Pemrograman</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Website" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">Website</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Java" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">Java</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="OOP" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">OOP</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox5" value="MVC" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">MVC</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox6" value="Kalkulus" name="tags[]">
                    <label class="form-check-label" for="inlineCheckbox1">Kalkulus</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox7" value="Lainnya" name="tags[]">
